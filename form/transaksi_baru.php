    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Membuat Transaksi Baru</h1>
                    <p class="mb-5">Silakan pilih jenis transaksi</p>
                    <a class="btn btn-primary mb-4 ml-md-0" href="form_transaksi_pelanggan_baru.php" role="button">Pelanggan Baru</a>
                    <a class="btn btn-success ml-md-3 mb-4" href="form_transaksi_data_pelanggan_sudah_ada.php" role="button">Data Pelanggan Sudah Ada</a>
                </div>
            </div>
            <!-- End of Main Content -->
